...
setlocal
chcp 65001 >nul
REM Camarones Documenter launcher for Windows. Double-click it, or run:  camarones.cmd help
...
:nouv
echo.
echo uv is not installed. Install it once, then open camarones.cmd again:
